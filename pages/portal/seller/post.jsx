...
// İLAN VERME SAYFASI — TEMİZ JS (Next.js derleme hatası yok)
...
export default function Page() {
  ...
  const STR = {
    tr: {
      ...
      PAGE_TITLE: "İLAN VER",
      SUBTITLE:
        "Foto → başlık → açıklama → kategori → alt kategori → il → ilçe → fiyat.",
      MEMBERSHIP: "Üyelik",
      PRO: "PRO",
      STANDARD: "STANDART",
      REMAINING: "Kalan kota",
      ADS_THIS_MONTH: "Bu ayki ilan sayınız",
      SHOWCASE_THIS_MONTH: "Bu ayki vitrin sayınız",
      CATEGORY: "Kategori",
      ...
      DRAG: "Dosyaları sürükleyin ya da tıklayın",
      ESTIMATE: "Tahmini Ücret",
      FEE_DETAIL: "Kota aşımı / vitrin seçimine göre hesaplanır.",
      SUBMIT: "Yayınla",
      CANCEL: "İptal",
      RULES_TITLE: "Kurallar",
      R1: "PRO: ayda 10 ilan.",
      R2: "STANDART: ayda 1 ilan.",
      R3: "PRO: ayda 1 vitrin ücretsiz.",
      R4: "Kota aşımı: PRO 100 TL, STANDART 150 TL.",
      R5: "Vitrin: PRO 150 TL (hakkı bittiyse), STANDART 299 TL.",
      R6: "Tüm ilanlar önce ADMIN ONAYINA gider.",
      WILL_SHOWCASE: "Onay sonrası Ana Sayfa › Vitrin'e düşer.",
      WILL_STANDARD: "Onay sonrası Standart alana düşer.",
      VERIFIED: "ONAYLI SATICI",
      GOLD_HINT: "PRO ilanları ALTIN çerçevede görünür.",
      ERR_MAX5: "En fazla 5 foto.",
      UPLOADING: "Yükleniyor…",
      DONE: "Gönderildi.",
      NEED_PAYMENT: "Ödeme gerekli: ",
      GO_PAY: "Ödemeye git",
      AFTER_REVIEW: "İlanınız incelendikten sonra yayına alınacaktır.",
    },
    en: {
      BRAND: "ÜRETEN ELLER",
      PAGE_TITLE: "POST LISTING",
      SUBTITLE:
        "Photos → title → description → category → subcategory → city → district → price.",
      MEMBERSHIP: "Membership",
      PRO: "PRO",
      STANDARD: "STANDARD",
      REMAINING: "Remaining quota",
      ADS_THIS_MONTH: "Your ads this month",
      SHOWCASE_THIS_MONTH: "Your showcase this month",
      CATEGORY: "Category",
      ...
      DESC: "Description",
      PHOTOS: "Photos (max 5)",
      DRAG: "Drag files or click to upload",
      ESTIMATE: "Estimated Fee",
      FEE_DETAIL: "Calculated from quota / showcase.",
      SUBMIT: "Publish",
      CANCEL: "Cancel",
      RULES_TITLE: "Rules",
      R1: "PRO: 10 / month.",
      R2: "STANDARD: 1 / month.",
      R3: "PRO: 1 showcase / month free.",
      R4: "Over-quota: PRO 100 TRY, STANDARD 150 TRY.",
      R5:
        "Showcase: PRO 150 TRY (if no free left), STANDARD 299 TRY.",
      R6: "All listings require ADMIN APPROVAL first.",
      WILL_SHOWCASE: "After approval appears on Home › Showcase.",
      WILL_STANDARD: "After approval appears in Standard list.",
      VERIFIED: "VERIFIED SELLER",
      GOLD_HINT: "PRO listings show with GOLD frame.",
      ERR_MAX5: "Max 5 photos.",
      UPLOADING: "Uploading…",
      DONE: "Submitted.",
      NEED_PAYMENT: "Payment required: ",
      GO_PAY: "Proceed to payment",
      AFTER_REVIEW:
        "Your listing will be published after review.",
    },
    ar: {
      BRAND: "أُورَتِن إِلَّر",
      PAGE_TITLE: "أَضِفْ إِعْلَانًا",
      SUBTITLE:
        "صور ← العنوان ← الوصف ← الفئة ← الفرعية ← الولاية ← القضاء ← السعر.",
      MEMBERSHIP: "العضوية",
      PRO: "برو",
      STANDARD: "عادي",
      REMAINING: "المتبقّي",
      ADS_THIS_MONTH: "إعلانات هذا الشهر",
      SHOWCASE_THIS_MONTH: "عروض مميزة هذا الشهر",
      CATEGORY: "الفئة",
      SUBCATEGORY: "الفرعية",
      CITY: "الولاية",
      DISTRICT: "القضاء",
      ...
      DESC: "الوصف",
      PHOTOS: "صور (حتى 5)",
      DRAG: "اسحب الملفات أو انقر للرفع",
      ESTIMATE: "الرسوم التقديرية",
      FEE_DETAIL: "بحسب الحصة/المميّز.",
      SUBMIT: "نشر",
      CANCEL: "إلغاء",
      RULES_TITLE: "القواعد",
      R1: "برو: 10 شهريًا.",
      R2: "عادي: 1 شهريًا.",
      R3: "برو: مميّز واحد مجانًا شهريًا.",
      R4: "تجاوز الحصة: برو 100 TL، عادي 150 TL.",
      R5:
        "المميّز: برو 150 TL (إن نفدت المجانية)، عادي 299 TL.",
      R6: "كل الإعلانات تتطلّب موافقة الإدارة أولًا.",
      WILL_SHOWCASE: "بعد الموافقة يظهر في الرئيسية › المميز.",
      WILL_STANDARD: "بعد الموافقة يظهر في القائمة العادية.",
      VERIFIED: "بائع موثّق",
      GOLD_HINT: "إعلانات برو بإطار ذهبي.",
      ERR_MAX5: "الحد 5 صور.",
      UPLOADING: "جارٍ الرفع…",
      DONE: "تم الإرسال.",
      NEED_PAYMENT: "يلزم دفع: ",
      GO_PAY: "انتقال للدفع",
      AFTER_REVIEW: "سيُنشر إعلانك بعد المراجعة.",
    },
    de: {
      BRAND: "ÜRETEN ELLER",
      PAGE_TITLE: "ANZEIGE AUFGEBEN",
      SUBTITLE:
        "Fotos → Titel → Beschreibung → Kategorie → Unterkategorie → Stadt → Bezirk → Preis.",
      MEMBERSHIP: "Mitgliedschaft",
      PRO: "PRO",
      STANDARD: "STANDARD",
      REMAINING: "Restkontingent",
      ADS_THIS_MONTH: "Deine Anzeigen (Monat)",
      SHOWCASE_THIS_MONTH: "Deine Schaufenster (Monat)",
      CATEGORY: "Kategorie",
      ...
      STANDARD_L: "Standard",
      SHOWCASE_L: "Schaufenster",
      TITLE: "Titel",
      PRICE: "Preis (TRY)",
      DESC: "Beschreibung",
      PHOTOS: "Fotos (max. 5)",
      DRAG: "Dateien ziehen oder klicken",
      ESTIMATE: "Vorauss. Gebühr",
      FEE_DETAIL: "aus Kontingent/Schaufenster.",
      SUBMIT: "Veröffentlichen",
      CANCEL: "Abbrechen",
      RULES_TITLE: "Regeln",
      R1: "PRO: 10 / Monat.",
      R2: "STANDARD: 1 / Monat.",
      R3: "PRO: 1 Schaufenster/Monat gratis.",
      R4: "Überkontingent: PRO 100 TRY, STANDARD 150 TRY.",
      R5:
        "Schaufenster: PRO 150 TRY (wenn gratis verbraucht), STANDARD 299 TRY.",
      R6: "Alle Anzeigen zuerst ADMIN-Freigabe.",
      WILL_SHOWCASE:
        "Nach Freigabe: Start › Schaufenster.",
      WILL_STANDARD:
        "Nach Freigabe: Standardliste.",
      VERIFIED: "VERIFIZIERTER VERKÄUFER",
      GOLD_HINT: "PRO-Anzeigen mit GOLD-Rahmen.",
      ERR_MAX5: "Max. 5 Fotos.",
      UPLOADING: "Wird hochgeladen…",
      DONE: "Gesendet.",
      NEED_PAYMENT: "Zahlung nötig: ",
      GO_PAY: "Zur Zahlung",
      AFTER_REVIEW:
        "Deine Anzeige wird nach Prüfung veröffentlicht.",
    },
  };
  ...
  const CATS = React.useMemo(
    () => ({
      tr: [
        ...
        {
          key: "local",
          title: "Yöresel / Kışlık",
          subs: [
            "Erişte",
            "Tarhana",
            "Yufka",
            "Mantı",
            "Kurutulmuş sebze-meyve",
            "Salça",
            "Sirke",
            "Konserve",
          ],
        ...
        {
          key: "amigurumi",
          title: "Amigurumi & Oyuncak (dekoratif)",
          subs: [
            "Anahtarlık",
            "Magnet",
            "Koleksiyon figürü",
            "Dekor bebek/karakter",
            "İsimli amigurumi",
          ],
        },
      ],
      en: [
        ...
        {
          key: "local",
          title: "Local / Pantry Staples",
          subs: [
            "Homemade noodles (erişte)",
            "Tarhana",
            "Yufka",
            "Mantı",
            "Dried veg/fruit",
        ...
        {
          key: "amigurumi",
          title: "Amigurumi & Toys (decorative)",
          subs: [
            "Keychain",
            "Magnet",
            "Collector figure",
            "Decor doll/character",
      ...
      ar: [
        ...
        {
          key: "local",
          title: "منتجات محلية / مؤن",
          subs: [
            "معكرونة منزلية (إريشته)",
            "طرخانة",
            "يوفكا",
            "مانتي",
            "خضار/فاكهة مجففة",
        ...
        {
          key: "diet",
          title: "دايت / نباتي / خالٍ من الغلوتين",
          subs: [
            "أطباق لياقة",
            "وجبات نباتية",
            "مخبوزات GF",
        ...
        {
          key: "home",
          title: "ديكور المنزل وإكسسواراته",
          subs: [
            "أعمال لباد",
            "وسادة",
            "إكليل الباب",
        ...
        {
          key: "amigurumi",
          title: "أميغورومي وألعاب (ديكورية)",
          subs: [
            "ميدالية مفاتيح",
            "مغناطيس",
            "مجسمات تجميع",
      ...
      de: [
        ...
        {
          key: "jam",
          title: "Marmelade • Pickles • Saucen",
          subs: [
            "Marmelade",
            "Pekmez (Traubensirup)",
            "Eingelegtes",
        ...
        {
          key: "sew",
          title: "Nähen / Schneiderei",
          subs: [
            "Saum/Reparaturen",
            "Reißverschlusswechsel",
            "Vorhänge nähen",
            "Bettwäsche/Kissen",
            "Tischdecke",
            "Maßanfertigung",
        ...
        {
          key: "amigurumi",
          title: "Amigurumi & Spielzeug (dekorativ)",
          subs: [
            "Schlüsselanhänger",
            "Magnet",
            "Sammlerfigur",
            "Deko-Puppe/Charakter",
            "Amigurumi mit Namen",
          ],
        },
      ],
  ...
  const MOTTO = {
    tr: [
      "Küçük üreticiye büyük destek",
      "Güvenli ödeme, kolay iade",
      "Şeffaf fiyat, net teslimat",
    ],
    en: [
      "Big support for small producers",
      "Secure payment, easy returns",
      "Transparent price, clear delivery",
    ],
    ar: ["دعم كبير للمنتِج الصغير", "دفع آمن وإرجاع سهل", "سعر شفاف وتسليم واضح"],
    de: [
      "Große Unterstützung für kleine Produzenten",
      "Sichere Zahlung, einfache Rückgabe",
      "Transparente Preise, klare Lieferung",
    ],
  };
  const BAD_WORDS = [
    "amk",
  ...
  React.useEffect(() => {
    const id = setInterval(() => {
      const mLen = (MOTTO[lang] || MOTTO.tr).length;
      setMi((p) => ((p + 1) % (mLen || 1)));
    }, 5000);
    ...
    (async () => {
      try {
        ...
        unsub = onAuthStateChanged(auth, async (user) => {
          ...
          setAdsThisMonth(c1.data().count || 0);
          setShowcaseThisMonth(c2.data().count || 0);
        });
      } catch (e) {
        console.warn("Firebase init (preview)", e);
      }
    })();
    return () => unsub();
  }, []);
  ...
  const showcaseFee =
    listingType === "showcase" && showcaseUsedUp ? (isPro ? 150 : 299) : 0;
  const needPayment = extraAdFee + showcaseFee;
  React.useEffect(() => {
    if (needPayment > 0) {
      setPayWarn(`${t.NEED_PAYMENT}${needPayment} TL`);
    } else setPayWarn("");
  }, [needPayment, lang]);
  React.useEffect(() => {
    const list = catList || [];
    if (!list.find((s) => s.key === catKey)) {
      setCatKey((list[0] && list[0].key) || "food");
    }
  }, [lang]); // catList türevi lang
  React.useEffect(() => {
    const subs = Array.isArray(cat.subs) ? cat.subs : [];
    if (!subs.includes(subcat)) setSubcat(subs[0] || "");
  }, [catKey, lang]); // cat değişir
  ...
  async function onSubmit(e) {
    ...
    if (BAD_WORDS.some((w) => haystack.includes(w))) {
      alert("Küfür / yasaklı kelime tespit edildi. Lütfen metni düzenleyin.");
      return;
    }
    try {
      setUploading(true);
      ...
      for (let i = 0; i < photos.length; i++) {
        const f = photos[i];
        const path = `listings/${uid || "anon"}/${Date.now()}_${i}_${(f && f.name) || "photo"}`;
      ...
      const docData = {
        ...
        city,
        district,
        isShowcase: listingType === "showcase",
        ...
        needPayment:
          needPayment > 0
            ? {
                amount: needPayment,
                items: { extraAd: extraAdFee > 0, showcase: showcaseFee > 0 },
              }
            : null,
        photos: urls,
        membership: isPro ? "pro" : "standard",
      };
      await addDoc(collection(db, "listing_submissions"), docData);
      setUploading(false);
      alert(
        `${t.DONE}
${t.AFTER_REVIEW}${
      ...
      if (typeof window !== "undefined") {
        if (needPayment > 0) {
          window.location.href = `/portal/pay?amount=${needPayment}`;
        } else {
          window.location.href = `/portal/seller`;
        }
      }
    } catch (err) {
      console.error(err);
  ...
  return (
    <main lang={lang} dir={DIR} className="min-h-screen">
        ...
        <div className="wrap flex items-center gap-3 py-3">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <div className="mem">
              ...
              <span className={`memTag ${isPro ? "pro" : ""}`}>
                {isPro ? t.PRO : t.STANDARD}
              </span>
            </div>
          </div>
        </div>
      ...
      <section className="wrap tcenter mt-4">
        ...
        <div className="motto" data-i={mi}>
          {(MOTTO[lang] || MOTTO.tr)[mi]}
        </div>
      </section>
      ...
      <section className="wrap grid3 mt-4">
        <div className="infoCard">
          ...
          <div className="infoMain">
            {Math.max(0, (isPro ? 10 : 1) - adsThisMonth)} / {isPro ? 10 : 1}
          </div>
          <div className="infoFoot">
            {t.ADS_THIS_MONTH}: {adsThisMonth} • {t.SHOWCASE_THIS_MONTH}: {showcaseThisMonth}
          </div>
        </div>
        <div className="infoCard">
          ...
          <div className="infoMain">
            ...
            showcaseThisMonth >= (isPro ? 1 : 0)
              ? isPro
                ? 150
                : 299
              : 0) + (adsThisMonth + 1 > (isPro ? 10 : 1) ? (isPro ? 100 : 150) : 0)}{" "}
            TL
          </div>
        ...
        <div className="col">
          <div className="card">
            ...
            <div className="uploader">
              <input
                ...
                multiple
                onChange={(ev) => {
                  const arr = Array.from(ev.currentTarget.files || []);
                  if (arr.length > 5) {
                    alert(t.ERR_MAX5);
                    return;
                  }
          ...
          <div className="card">
            ...
            <textarea
              ...
              className="inp"
              placeholder="Ürün açıklaması, içerik, teslimat…"
            />
          </div>
          ...
          <div className="grid2">
            ...
            <div className="card">
              ...
              <select
                ...
                className="inp"
              >
                {(Array.isArray(cat.subs) ? cat.subs : []).map((s) => (
          ...
          <div className="grid2">
            ...
            <div className="card">
              ...
              <div className="toggle">
                <button
                  type="button"
                  className={`pill ${listingType === "standard" ? "on" : ""}`}
                ...
                <button
                  type="button"
                  className={`pill ${listingType === "showcase" ? "on" : ""}`}
          ...
          <div className={`card ${isPro ? "goldOutline" : ""}`}>
            <div className="veri">
              <span className="vTtl">{t.VERIFIED}</span>
              {isPro && <span className="vTag">{t.PRO}</span>}
            </div>
            <div className="vHint">{t.GOLD_HINT}</div>
          </div>

          <div className="actions">
            <button disabled={uploading} type="submit" className="btnPrimary">
              {uploading ? t.UPLOADING : t.SUBMIT}
            </button>
            {(adsThisMonth + 1 > (isPro ? 10 : 1) ||
              (listingType === "showcase" &&
                showcaseThisMonth >= (isPro ? 1 : 0))) && (
              <button
                type="button"
                    ...
                    const amount =
                      ...
                      showcaseThisMonth >= (isPro ? 1 : 0)
                        ? isPro
                          ...
                          : 299
                        : 0);
                    window.location.href = `/portal/pay?amount=${amount}`;
                  }
                }}
                className="btnGhost"
              >
      ...
      <footer className="footer">
        <div className="wrap">
          ...
          <nav className="footLinks">
            ...
            <a href="/legal/topluluk-kurallari">
              {lang === "tr"
                ? "TOPLULUK KURALLARI"
                : lang === "en"
